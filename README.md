# 台灣漢文資訊字彙英漢對照表
WordPress 台灣漢文的漢英對照字彙表，在大致滿足 WordPress 台灣社群需求後，會擴充至其他資訊 IT 領域的英漢字彙。這份字彙表由 [Alex Lion (阿力獅)](https://www.facebook.com/captain.alexlion) 維護。這份詞彙表是實際使用於阿力獅目前持續處理的 WordPress 台灣漢文版核心程式、外掛及佈景主題語言套件中，所以絕對有一定程度的實用價值。
## 字彙表更新優先順序
